...
kw_map = {
    "로봇청소기": "nkw-a001-01-000008056485201",
    "무선청소기": "nkw-a001-01-000008056485205",
    "헤어드라이기": "nkw-a001-01-000008056485208",
    "물걸레청소기": "nkw-a001-01-000008056485211",
}
...
for kw_text, kw_id in kw_map.items():
    ...
    for device, bids_dict in [("PC", pc_bids), ("MOBILE", mo_bids)]:
        ...
        for item in res["data"].get("estimate", []):
            bids_dict[item["position"]] = item.get("bid", 70)
